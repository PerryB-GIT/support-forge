#!/usr/bin/env python3
"""
Generate slides for 8.2 Building Client Onboarding Agent - Part 2
Segments 15-28
"""
...
SCREENSHOTS_DIR = SCRIPT_DIR / "output/slide-images/screenshots"
...
def main():
    ...
    print("=" * 60)
    print("Generating Slides for 8.2 Part 2 - Client Onboarding Agent")
    print(f"Segments {MIN_SEGMENT}-{MAX_SEGMENT}")
    print("=" * 60)
    ...
    # Filter to part 2 segments
    part2_segments = [s for s in segments
                      if MIN_SEGMENT <= s.get('segment_id', 0) <= MAX_SEGMENT]
    print(f"Processing {len(part2_segments)} segments for Part 2")
    ...
    for seg in part2_segments:
        ...
        if output_path.exists():
            print(f"Slide {seg_id} already exists, skipping...")
            continue
    ...
    print(f"\nGenerated slides in {OUTPUT_DIR}")
